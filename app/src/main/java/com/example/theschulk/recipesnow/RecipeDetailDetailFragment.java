 ...
 * in two-pane mode (on tablets) or a {@link RecipeDetailDetailActivity}
 * on handsets.
 */
public class RecipeDetailDetailFragment extends Fragment {
    /**
    ...
    public RecipeDetailDetailFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
       //     ((TextView) rootView.findViewById(R.id.recipedetail_detail)).setText(mItem.details);
        }
